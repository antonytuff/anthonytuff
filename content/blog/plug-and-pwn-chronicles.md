...
date: 2025-05-08
tags: hak5, lan-turtle, initial-access, red-teaming
description: A hands-on guide to deploying the Hak5 LAN Turtle for covert network access during Red Team engagements, covering setup, reverse SSH tunneling, and pivoting with ProxyChains.
---
...
![](../static/img/Turtle/Pasted%20image%2020250508003229.png)
...
![](../static/img/Turtle/Pasted%20image%2020250506101942.png)
![](../static/img/Turtle/Pasted%20image%2020250506101323.png)
...
***Pro tip:*** Change the default password immediately if you're going to deploy this in a real network. You don't want _your_ backdoor getting hijacked.
![](../static/img/Turtle/Pasted%20image%2020250506102039.png)
...
![](../static/img/Turtle/Pasted%20image%2020250506102112.png)
![](../static/img/Turtle/Pasted%20image%2020250506102139.png)
![](../static/img/Turtle/Pasted%20image%2020250506205422.png)
...
- See below steps
![](../static/img/Turtle/Pasted%20image%2020250508014431.png)
![](../static/img/Turtle/Pasted%20image%2020250507003313.png)
![](../static/img/Turtle/Pasted%20image%2020250507003512.png)
Next, copy the public key from the Turtle to your C2 server's `authorized_keys`, we can use SSH Copy ID for this step
![](../static/img/Turtle/Pasted%20image%2020250508013347.png)
![](../static/img/Turtle/Pasted%20image%2020250508015728.png)
...
```
![](../static/img/Turtle/Pasted%20image%2020250508195249.png)
...
```
![](../static/img/Turtle/Pasted%20image%2020250507015558.png)
...
```
![](../static/img/Turtle/Pasted%20image%2020250508213959.png)
...
```
![](../static/img/Turtle/Pasted%20image%2020250507020859.png)
