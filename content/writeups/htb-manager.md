...
difficulty: medium
description: Windows AD box - RID cycling, MSSQL exploitation, AD CS ESC7 attack for privilege escalation to Domain Admin.
---
...
| 80                   | Web Service                      | Likely hosting a website or web application.                       | Enumerate directories and files using tools like Gobuster or Dirbuster. Test for any injection points for web related vulnerabilities. Fuzzing directories, looking for potential usernames |
...
![](../static/img/Pasted%20image%2020250105133859.png)

![](../static/img/Pasted%20image%2020250105134610.png)
...
![](../static/img/Pasted%20image%2020250105140006.png)
Checking if there are any hidden directories and files on the web service. (**Nothing Found**)

![](../static/img/Pasted%20image%2020250105140220.png)

Default page of the website
![](../static/img/Pasted%20image%2020250105162710.png)
...
```
![](../static/img/Pasted%20image%2020250105171724.png)
...
![](../static/img/Pasted%20image%2020250105201547.png)
...
![](../static/img/Pasted%20image%2020250105164951.png)
...
```
![](../static/img/Pasted%20image%2020250105192243.png)
...
![](../static/img/Pasted%20image%2020250105195020.png)
```
cat domainusers.txt | tr '[:lower:]' '[:upper:]' > uppercase_users.txt
```
![](../static/img/Pasted%20image%2020250105193915.png)
...
```
![](../static/img/Pasted%20image%2020250105205121.png)
...
![](../static/img/Pasted%20image%2020250105202018.png)
...
![](../static/img/Pasted%20image%2020250105212138.png)
...
![](../static/img/Pasted%20image%2020250213214108.png)


![](../static/img/Pasted%20image%2020250213215416.png)
...
![](../static/img/Pasted%20image%2020250213220321.png)

Downloading the Back up File

![](../static/img/Pasted%20image%2020250213220513.png)
...
![](../static/img/Pasted%20image%2020250213220715.png)


We can use this credentials to attempt to login to the server through evil-winrm as indicated below;, Poked around, and guess what? The user flag was just chilling on the desktop. Easy win. Let's keep this party going.
```python
evil-winrm  -i manager.htb -u raven -p 'R4v3nBe5tD3veloP3r!123'   `
```

![](../static/img/Pasted%20image%2020250213221643.png)
...
```
![](../static/img/Pasted%20image%2020250105220502.png)
...
```
![](../static/img/Pasted%20image%2020250216002936.png)
...
```
![](../static/img/Pasted%20image%2020250106200058.png)

Verify the template has been enabled

![](../static/img/Pasted%20image%2020250106195957.png)
...
```
![](../static/img/Pasted%20image%2020250216003600.png)
...
```
![](../static/img/Pasted%20image%2020250216004907.png)
...
```
![](../static/img/Pasted%20image%2020250216005318.png)

###### Step 6 Authenticate with the certificate:
```
...
![](../static/img/Pasted%20image%2020250216010137.png)
...
- Key takeaways include:
    ...
    3. Avoid running services with elevated privileges unless absolutely necessary.
By chaining misconfigurations and outdated configurations, I successfully escalated privileges to root.
