...
date: 2025-02-16
tags: htb, windows, hackthebox-walkthrough, privilege-escalation, active-directory
description: Walkthrough for the HackTheBox Cicada machine, involving RID brute-forcing, SMB enumeration, credential discovery, and privilege escalation via SeBackupPrivilege abuse to dump SAM hashes.
difficulty: easy
---

![You Are Here Sign](../static/img/Pasted%20image%2020250219235705.png)
...
My first go to was to perform RID Brute-forcing using crackmapexec, aiming to enumerate user accounts on the Domain Controller (DC). This technique abuses the Relative Identifier (RID) sequencing, allowing us to query Security Identifiers (SIDs) and resolve them into usernames--often without authentication. The results are as follows:

```
crackmapexec smb 10.10.11.35  -u 'guest'  -p '' --rid-brute | tee domainusersv1.txt
```

![](../static/img/Pasted%20image%2020241231095940.png)
...
![](../static/img/Pasted%20image%2020241231131133.png)

Even though this attempt didn't yield a direct credential dump, the username list remains a valuable foothold for further attacks. Next, We can explore another vector such enumerating services to identify potential misconfigurations. In my case we can check SMB;
...
![](../static/img/Pasted%20image%2020241230225850.png)
...
![](../static/img/Pasted%20image%2020241230230616.png)
...
![](../static/img/Pasted%20image%2020241231103313.png)
...
```
![](../static/img/Pasted%20image%2020241231114657.png)
...
![](../static/img/Pasted%20image%2020241231114849.png)
...
![](../static/img/Pasted%20image%2020241231115131.png)

![](../static/img/Pasted%20image%2020250105163258.png)
...
![](../static/img/Pasted%20image%2020241231104652.png)
...
whoami /priv
```
![](../static/img/Pasted%20image%2020241231115359.png)
...
![](../static/img/Pasted%20image%2020250219223740.png)
...
![](../static/img/Pasted%20image%2020241231122509.png)
...
```
![](../static/img/Pasted%20image%2020241231125333.png)
...
```
![](../static/img/Pasted%20image%2020241231130245.png)
