...
difficulty: medium
description: Windows AD box - AS-REP Roasting, BloodHound ACL abuse, DCSync with Cobalt Strike, and WriteDACL exploitation.
---


![](../static/img/Forest/Pasted%20image%2020250301214344.png)
#  Overview
...
![](../static/img/Forest/Pasted%20image%2020250301215039.png)
...
![](../static/img/Forest/Pasted%20image%2020250301220830.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250301230855.png)
![](../static/img/Forest/Pasted%20image%2020250301230946.png)

![](../static/img/Forest/Pasted%20image%2020250301231041.png)
![](../static/img/Forest/Pasted%20image%2020250301231139.png)
For Sysadmins reading this- This is a goldmine for attackers, as it can expose privileged accounts, domain users,  misconfigured groups, or potential password reuse scenarios if any. Additionally, it provides a blueprint of the domain's organizational structure, allowing a threat actor to plan an attack with a greater precision.
```
rpcclient -U '' -N 10.10.10.161
```
![](../static/img/Forest/Pasted%20image%2020250301224054.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250301224241.png)
![](../static/img/Forest/Pasted%20image%2020250301223305.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250301224649.png)
```
...
```
![](../static/img/Forest/Pasted%20image%2020250301224934.png)
### Intial FootHold
...
![](../static/img/Forest/Pasted%20image%2020250301225117.png)
...
![](../static/img/Forest/Pasted%20image%2020250301225729.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250304084420.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250302005705.png)

![](../static/img/Forest/Pasted%20image%2020250302005706.png)
...
![](../static/img/Forest/Pasted%20image%2020250301232433.png)
...
1. **What is my goal?** - Am I looking for a path to escalate privileges, lateral movement, or domain dominance?
2. **Who has control over what?** - Which accounts have privileged access or administrative rights?
3. **What permissions are misconfigured?** - Look for WriteDACL, GenericWrite, or Owns attributes on objects.
4. **What attack paths exist?** - Can I abuse ACLs, AS-REP roastingKerberoastable accounts, or constrained delegation?
5. **Can I move laterally?** - Are there sessions, local admin access, or delegation settings that I can exploit?
...
![](../static/img/Forest/Pasted%20image%2020250301233135.png)
...
![](../static/img/Forest/Pasted%20image%2020250301233833.png)
...
![](../static/img/Forest/Pasted%20image%2020250302000500.png)

![](../static/img/Forest/Pasted%20image%2020250302162920.png)
![](../static/img/Forest/Pasted%20image%2020250302004527.png)
This means we can add our Membership to the "Exchange Windows Permissions" group
![](../static/img/Forest/Pasted%20image%2020250302170245.png)
...
![](../static/img/Forest/Pasted%20image%2020250302165612.png)
...
![](../static/img/Forest/Pasted%20image%2020250302171604.png)
Creating a listener
![](../static/img/Forest/Pasted%20image%2020250302172012.png)

![](../static/img/Forest/Pasted%20image%2020250302172714.png)


uploading the Stager
![](../static/img/Forest/Pasted%20image%2020250302173211.png)
...
```
![](../static/img/Forest/Pasted%20image%2020250302173350.png)
We now have a beacon on hosts.
![](../static/img/Forest/Pasted%20image%2020250302173414.png)
...
![](../static/img/Forest/Pasted%20image%2020250302173656.png)
![](../static/img/Forest/Pasted%20image%2020250302175258.png)
![](../static/img/Forest/Pasted%20image%2020250302180121.png)

![](../static/img/Forest/Pasted%20image%2020250302180349.png)
Privilege Escalation
...
![](../static/img/Forest/Pasted%20image%2020250302225055.png)

![](../static/img/Forest/Pasted%20image%2020250302203214.png)

```
make_token Administrator htb.local 32693b11e6aa90eb43d32c72a07ceea6
```
![](../static/img/Forest/Pasted%20image%2020250303212822.png)
![](../static/img/Forest/Pasted%20image%2020250303201318.png)
...
![](../static/img/Forest/Pasted%20image%2020250303211749.png)
